...
import { Trophy, AlertCircle, Sparkles, X, ChevronDown, Lock } from "lucide-react";
...
function RankingBoard({ ranking, onShowAll, phase, finalScore, isGuest }: { ranking: RankEntry[], onShowAll: () => void, phase: GamePhase, finalScore: number, isGuest: boolean }) {
    return (
